# E 定向复验（PARTIAL）——A f6e500e，run E-AB-20260910T152407Z-62cd1bee
...
| 项 | 检查 | 状态 | 命令/rc | 关键摘录 |
|---|---|---|---|---|
| RV-1 | 从当前源码重建：A 源码==f6e500e（git diff 空）+ 构建 jar + 启动健康 | **PASS** | git diff f6e500e -- web-java worker-python contracts; mvn -DskipTests package; java -jar / 0 | diff_empty=True HEAD=d495a7d7c43a jar=web-java-0.0.1-SNAPSHOT.jar sha256[:16]=c449fdd1a6190d9d health_up=True |
| RV-2 | marker 变体闭合：投影仅 null 或 {reason∈枚举,retryable:bool}，marker/原始 code/message 缺席 | **PASS** | UPDATE RETURNING count==1 + GET echo job / 200 | sql_ok=True proj={'reason': 'internal', 'retryable': True} leaked=False body={"requestId": "9dfefb74-72c8-4e6e-ae0c-48f7743c6658", "data": {"jobId": "f736ab79-6948-4df4-9619-b0572ed5d3f9", "status": "queued", "attemptCount": "0", "leaseRevision": "0", "finishedAt": null, "lastError": {"reason": " |
