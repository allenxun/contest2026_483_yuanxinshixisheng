# E C/M4 黑盒验收 —— C 8b3592e，run E-AB-20260911T090147Z-6d8dbb55
...
| 项 | 检查 | 状态 | 命令/rc | 关键摘录 |
|---|---|---|---|---|
| CC-01 | 构建与启动绑定：HEAD=93b7e33、8b3592e 祖先、源码 diff 空、当前源码构建、health UP | **PASS** | git merge-base/diff; mvn -DskipTests package; java -jar / 0 | HEAD=4b5ed51fcaff ancestor=True diff_files=[] jar=web-java-0.0.1-SNAPSHOT.jar sha16=7c79f7cc3ea39a76 |
