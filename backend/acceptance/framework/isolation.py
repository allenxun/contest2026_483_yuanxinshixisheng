...
ENV_RUN_ID = "E_ACCEPTANCE_RUN_ID"   # 由 run.sh 注入，绑定本次哨兵 reports/<run-id>/settlement.json
...
ALL_ENV_KEYS = (ENV_BASE_URL, ENV_RUN_PREFIX, ENV_RUN_ID, ENV_PG_HOST, ENV_PG_PORT,
