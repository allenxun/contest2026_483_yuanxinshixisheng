...
import com.example.aisia.ui.consult.AiConsultActivity
import com.google.android.material.card.MaterialCardView

/**
 * 肌肤智能检测页面 —— 对应小程序 skinAnalysis 页面
 * 展示三张功能卡片：肤质检测、3D人脸模型生成、人脸检测
 */
class SkinAnalysisActivity : AppCompatActivity() {
    ...
    private fun goToAiConsult(type: String) {
        val intent = Intent(this, AiConsultActivity::class.java).apply {
            putExtra("type", type)
        }
